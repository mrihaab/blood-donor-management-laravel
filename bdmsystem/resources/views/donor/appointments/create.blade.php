        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-calendar-plus"></i> Book Donation Appointment
                    </h5>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="location" id="location" class="form-control">
                                        <option value="Main Blood Bank" {{ old('location') == 'Main Blood Bank' ? 'selected' : '' }}>Main Blood Bank</option>
                                        <option value="City Center Branch" {{ old('location') == 'City Center Branch' ? 'selected' : '' }}>City Center Branch</option>
                                        <option value="Hospital Wing" {{ old('location') == 'Hospital Wing' ? 'selected' : '' }}>Hospital Wing</option>
                                        <option value="Mobile Unit" {{ old('location') == 'Mobile Unit' ? 'selected' : '' }}>Mobile Unit</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
